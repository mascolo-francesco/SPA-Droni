...
#Modello logico
Missione(ID, Data, OraInizio, LongPickup, LatPickup, LongConsegna, LatConsegna, Valutazione, stato,
	ID_Drone, ID_Pilota)
ID_Drone → Drone(ID)
ID_Pilota → Pilota(ID)
...
Ordine(ID, Tipo, PesoTotale, Orario, IndirizzoDestinazione, ID_Missione, ID_Utente)
